                            ...
                            <form onSubmit={handleSubmit} className="pt-4">
                                <div>
                                    ...
                                    <div className="flex -mx-3">
                                        <div className="w-1/2 px-3 mb-5">
                                            ...
                                            <div className="flex">
                                                ...
                                                <input type="text" className="w-full py-2 pl-10 pr-3 -ml-10 border-2 border-gray-200 rounded-lg outline-none dark:bg-white focus:border-orange-500" placeholder="F-Name" value={firstname} onChange={(e) => setFirstname(e.target.value)} required />
                                            </div>
                                        </div>
                                        <div className="w-1/2 px-3 mb-5">
                                            ...
                                            <div className="flex">
                                                <div className="z-10 flex items-center justify-center w-10 pl-1 text-center pointer-events-none"><i className="text-lg text-gray-400 mdi mdi-account-outline"></i></div>
                                                <input type="text" className="w-full py-2 pl-10 pr-3 -ml-10 border-2 border-gray-200 rounded-lg outline-none dark:bg-white focus:border-orange-500" placeholder="L-Name" value={lastname} onChange={(e) => setLastname(e.target.value)} required />
                                            </div>
                                        </div>
                                    </div>
                                    {/* firstnamee */}
                                    ...
                                    <div className="flex -mx-3">
                                        <div className="w-full px-3 mb-5">
                                            ...
                                            <div className="flex">
                                                ...
                                                <input type="email" className="w-full py-2 pl-10 pr-3 -ml-10 border-2 border-gray-200 rounded-lg outline-none dark:bg-white focus:border-orange-500" placeholder="johnsmith@example.com" value={email} onChange={(e) => setEmail(e.target.value)} required />
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="w-1/2 px-3 mb-5">
                                            ...
                                            <div className="relative flex ">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full py-2 pl-10 pr-3 -ml-10 border-2 border-gray-200 rounded-lg outline-none dark:bg-white focus:border-orange-500"
                                        ...
                                        <div className="w-1/2 px-3 mb-5">
                                            ...
                                            <div className="relative flex">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full py-2 pl-6 pr-3 -ml-10 border-2 border-gray-200 rounded-lg outline-none dark:bg-white focus:border-orange-500"
                                    ...
                                    <div className="flex -mx-3">
                                        <div className="w-full px-3 mb-5">
                                            <br />
                                            <button className="block w-full max-w-xs px-3 py-3 mx-auto font-semibold text-white bg-orange-500 rounded-lg hover:bg-orange-800 focus:bg-orange-500">REGISTER NOW</button>
                                        </div>
                                    </div>


                                    <center> <p className="mt-4">Already Registered ?&nbsp;&nbsp;&nbsp;<button onClick={handleLoginButton} className="font-semibold text-white text-sm bg-orange-500 rounded-lg p-[7px]  hover:bg-orange-800 focus:bg-orange-500">Login Now</button></p> </center>
...
export default Sales_Agent_Register;