                ...
                <div className="w-3/4 overflow-hidden text-gray-500 bg-gray-100 shadow-xl rounded-3xl dark:bg-gray-800 dark:text-gray-200" style={{ marginTop: '-100px' }}>
                    <div className="w-full md:flex">
                        <div className="hidden w-1/2 px-10 py-10 bg-red-500 md:block">
                            {/* <img src="https://www.svgrepo.com/show/44183/male-user.svg" alt="SVG Image"/> */}
                        ...
                        <div className="w-full px-5 py-10 md:w-1/2 md:px-10">
                            <div className="mb-10 text-center">
                                <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-200">Admin Registration</h1>
                                <br />
                                <p>Enter Admin/Manager Information</p>
                            </div>
                            ...
                            <form onSubmit={handleSubmit} className="pt-4">
                                <div>
                                    ...
                                    <div className="flex -mx-3">
                                        <div className="w-1/2 px-3 mb-5">
                                            ...
                                            <div className="flex">
                                                ...
                                                <input type="text" className="w-full py-2 pl-10 pr-3 -ml-10 border-2 border-gray-200 rounded-lg outline-none dark:bg-white focus:border-red-500" placeholder="F-Name" value={firstname} onChange={(e) => setFirstname(e.target.value)} required />
                                            </div>
                                        </div>
                                        <div className="w-1/2 px-3 mb-5">
                                            ...
                                            <div className="flex">
                                                <div className="z-10 flex items-center justify-center w-10 pl-1 text-center pointer-events-none"><i className="text-lg text-gray-400 mdi mdi-account-outline"></i></div>
                                                <input type="text" className="w-full py-2 pl-10 pr-3 -ml-10 border-2 border-gray-200 rounded-lg outline-none dark:bg-white focus:border-red-500" placeholder="L-Name" value={lastname} onChange={(e) => setLastname(e.target.value)} required />
                                            </div>
                                        </div>
                                    </div>
                                    {/* firstnamee */}
                                    ...
                                    <div className="flex -mx-3">
                                        <div className="w-full px-3 mb-5">
                                            ...
                                            <div className="flex">
                                                ...
                                                <input type="email" className="w-full py-2 pl-10 pr-3 -ml-10 border-2 border-gray-200 rounded-lg outline-none dark:bg-white focus:border-red-500" placeholder="johnsmith@example.com" value={email} onChange={(e) => setEmail(e.target.value)} required />
                                            </div>
                                        </div>
                                    </div>


                                    {/* again first name htmlFor password things */}
                                        ...
                                        <div className="w-1/2 px-3 mb-5">
                                            ...
                                            <div className="relative flex ">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full py-2 pl-10 pr-3 -ml-10 border-2 border-gray-200 rounded-lg outline-none dark:bg-white focus:border-red-500"
                                        ...
                                        <div className="w-1/2 px-3 mb-5">
                                            ...
                                            <div className="relative flex">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full py-2 pl-6 pr-3 -ml-10 border-2 border-gray-200 rounded-lg outline-none dark:bg-white focus:border-red-500"
                                    ...
                                    <div className="flex -mx-3">
                                        <div className="w-full px-3 mb-5">
                                            <br />
                                            <button className="block w-full max-w-xs px-3 py-3 mx-auto font-semibold text-white bg-red-500 rounded-lg hover:bg-red-800 focus:bg-red-700">REGISTER NOW</button>
                                        </div>
                                    </div>


                                    <center> <p className="mt-4">Already Registered ?&nbsp;&nbsp;&nbsp;<button onClick={handleLoginButton} className="font-semibold text-white text-sm p-[7px]  bg-red-500 rounded-lg hover:bg-red-800 focus:bg-red-700">Login Now</button></p> </center>
...
export default Admin_Register_Form;