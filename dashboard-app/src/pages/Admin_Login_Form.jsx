                        ...
                        <div className="w-full px-5 py-10 md:w-1/2 md:px-10">
                            ...
                            <form onSubmit={handleLogin}>
                                <div>
                                    ...
                                    <button type="submit" className="bg-red-500 hover:bg-red-800 text-white font-semibold rounded-md py-2 px-4 w-full">Login</button>
                                </div>
                            </form>

                            <div className="mt-10 text-black text-center dark:text-gray-200">Not Registered? &nbsp;&nbsp;&nbsp;
                                <a href="/admin_reg" className="hover:underline font-semibold text-white text-sm p-[7px] bg-red-500 rounded-lg hover:bg-red-800 focus:bg-red-500">
                                    Sign up Here
                                </a>
                            </div>
                        </div>
