  ...
  return (
      ...
      <main className="flex-1 rounded-tl-21xl rounded-tr-none rounded-b-none bg-white flex flex-col items-start justify-start pt-6 pb-[708px] pr-[34px] pl-[47px] box-border gap-[25px] min-w-[710px] max-w-full z-[1] text-left text-13xl text-black font-nunito lg:pl-[23px] lg:pt-5 lg:pb-[299px] lg:box-border mq750:pb-[194px] mq750:box-border mq750:min-w-full">
        ...
        <div className="flex flex-col items-start justify-start pt-0 px-0 pb-[3px] box-border gap-[1px] max-w-full">
          <h1 className="m-0 w-[220px] relative text-inherit font-bold font-inherit inline-block z-[2] mq450:text-lgi mq1050:text-7xl">
            Team Leaders
          </h1>
          <div className="relative text-base font-medium z-[2]">{`Manager > Sale Agents > Current Team Leaders`}</div>
        </div>
        <FrameComponent1 />
        <div className="w-96 flex flex-col items-start justify-start pt-0 px-0 pb-[9px] box-border gap-[6px] max-w-full">
          <h1 className="m-0 self-stretch relative text-inherit font-bold font-inherit z-[2] mq450:text-lgi mq1050:text-7xl">
            Add New Team Leader
          </h1>
          <div className="relative text-base font-medium inline-block max-w-full z-[2]">{`Manager > Sale Agents > Add New Team Leader`}</div>
        </div>
