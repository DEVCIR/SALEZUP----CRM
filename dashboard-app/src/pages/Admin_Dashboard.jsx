...
export default function Admin_Dashboard() {
    ...
    const renderPageContent = () => {
        switch (currentPage) {
            ...
            case 'Commission_Management':
                return <div className=''><Commision_Management /></div>;
            case 'Individual':
            ...
            case 'Teams':
                return <div className=''><SaleAgents /></div>;
            case 'TeamLeaders':
                return <div className=''><TeamLeaders /></div>;
            case 'Main_Dashboard':
                return <div className=''><DashboardManager /></div>;
            case 'Add_New_Agent':
                return <div className=''><Add_New_Agent /></div>;
            case 'Pending_Request':
                return <div className=''><Pending_Request /></div>;
            case 'Current_Team_Leader':
                return <div className=''><Current_Team_Leader /></div>;
            case 'Add_New_Team_Leader':
                return <div className=''><Add_New_Team_Leader /></div>;
            case 'Pending_Request_Team_Leader':
                return <div className=''><Pending_Request_Team_Leader /></div>;
            case 'Add_New_Teams':
                return <div className=''><Add_New_Teams /></div>;
            case 'Current_Teams':
                return <div className=''><Current_Teams /></div>;
            case 'Pending_Teams':
                return <div className=''><Pending_Teams /></div>;
            default:
    ...
    return (
        <div className="bg-[#072D20] flex flex-row">
            {/* Aside Menu */}
