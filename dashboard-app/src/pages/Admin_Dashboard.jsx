...
import Sales_Officer_Login from './Sales_Officer_Login';
...
export default function Admin_Dashboard() {
    ...
    const renderPageContent = () => {
        switch (currentPage) {
            ...
            case 'Analytics':
                return <div className='bg-yellow-500'><Sales_Officer_Login/></div>;
            case 'Commission Management':
                return <div className='bg-yellow-500'><Commision_Management/></div>;
            case 'Individual':
                return <div className='bg-yellow-500'><Individual/></div>;
            case 'Leaderboard':
                return <div className='bg-yellow-500'><Leaderboard/></div>;
            case 'SalesAgent':
