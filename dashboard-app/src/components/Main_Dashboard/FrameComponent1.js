...
const FrameComponent1 = ({
  ...
  return (
    <div
      className={`self-stretch shadow-[0px_12px_16px_-4px_rgba(0,_0,_0,_0.08)] rounded-3xl bg-white overflow-hidden flex flex-col items-start justify-start p-6 box-border gap-[26px] max-w-full text-center text-lg text-foundation-green-normal font-display-xs-semibold ${className}`}
    >
      ...
      <div className="self-stretch [filter:drop-shadow(0px_12px_16px_rgba(0,_0,_0,_0.08))] rounded-3xl flex flex-row flex-wrap items-center justify-center gap-[18px] max-w-full font-poppins">
        <div className="flex flex-col items-center justify-center py-5 px-0">
        ...
        <div className="flex-1 flex flex-col items-end justify-start gap-[16px] min-w-[640px] max-w-full font-display-xs-semibold mq975:min-w-full">
          <div className="w-[757px] flex flex-row items-center justify-start max-w-full">
            <div
              className="h-[41px] flex-1 flex flex-row items-center justify-between max-w-full gap-[20px]"
              style={teamImageStyle}
            >
              <div className="relative font-medium inline-block min-w-[12px]">
                0
              </div>
              <div className="relative font-medium inline-block min-w-[35px]">
                500
              ...
              <img
                className="h-[45px] w-[46px] relative object-cover"
                alt=""
                src="/image-45@2x.png"
              />
