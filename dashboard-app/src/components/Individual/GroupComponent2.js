...
const GroupComponent2 = ({ className = "" }) => {
  return (
    <div className={`shadow-[0px_20px_26.4px_-6px_rgba(0,_0,_0,_0.25)] rounded-16xl w-[95%] box-border flex flex-row items-center justify-between p-5 relative z-[2] text-center text-sm text-black border-t-[3.5px] border-solid border-silver-100 flex-wrap ${className}`}>
      <div className="flex flex-row items-start justify-start py-0 pr-2 pl-[15px] box-border max-w-full text-xl">
        <div className="flex-1 flex flex-row items-start justify-between max-w-full gap-[20px] mq950:flex-wrap">
          <div className="w-80 flex flex-col items-start justify-start box-border">
            <b className="font-semibold z-[1] mq450:text-base">
              Select Agents
            </b>
          </div>
          <div className="w-[250px] flex flex-col items-start justify-start gap-[8.8px] text-base text-gray-100">
            ...
            <select className=" h-[32.9px] relative rounded-[5.99px] bg-whitesmoke-100 box-border border-[0px] border-solid border-whitesmoke-100">
              <option value="option_1">Option 1</option>
            </select>
          </div>
        </div>
      </div>
      <div className=" flex flex-row items-start justify-start pt-0 pb-[3.7px] pr-2 pl-2.5 box-border max-w-full text-xl font-nunito">
        <div className="flex-1 flex flex-row items-end justify-between max-w-full gap-[20px] mq950:flex-wrap">
          <div className="w-[359px] flex flex-col items-start justify-start gap-[36px] max-w-full">
            ...
            <div className=" flex flex-row items-start justify-start py-0 pr-0 pl-[38px] box-border max-w-full text-smi font-inter">
              <div className="flex-1 flex flex-row items-start justify-start gap-[15px] max-w-full mq450:flex-wrap">
                ...
                <div className="flex-1 flex flex-col items-start justify-start pt-[22px] px-0 pb-0 box-border min-w-[170px]">
                  <div className=" h-0 relative leading-[0%] font-medium inline-block z-[1]">
                    Saif Ahmed siddqui
                  </div>
                </div>
              </div>
          ...
          <div className="w-72 flex flex-col items-start justify-end pt-0 px-0 pb-[6.9px] box-border">
            <div className=" flex flex-row items-end justify-start gap-[25px] mq450:flex-wrap">
              <div className="flex-1 flex flex-col items-start justify-start gap-[43px] min-w-[94px]">
                <b className=" relative font-bold shrink-0 [debug_commit:bf4bc93] z-[1] mq450:text-base">
                  Add Agents
                </b>
              ...
              <div className="w-[119px] flex flex-col items-start justify-end pt-0 px-0 pb-[25.1px] box-border min-w-[119px] text-xs font-inter mq450:flex-1">
                <div className=" flex flex-col items-start justify-start pt-0 px-0 pb-3 relative gap-[1px]">
                  ...
                  <div className=" rounded-t-8xs rounded-b-none bg-silver-200 flex flex-row items-start justify-start pt-3 px-[23px] pb-1.5 z-[2]">
      ...
      <div className=" flex flex-row items-start justify-start pt-0 px-0 pb-[7.7px] box-border max-w-full">
      ...
      <div className=" flex flex-row items-start justify-start pt-0 px-0 pb-[6.7px] box-border max-w-full">
        <div className="flex-1 shadow-[0px_4px_8.4px_rgba(0,_0,_0,_0.25)] rounded-[7.81px] [background:linear-gradient(90deg,_#f5f5f5,_rgba(45,_128,_133,_0.36))] flex flex-row items-end justify-start pt-2.5 px-12 pb-2 box-border gap-[428px] max-w-full z-[1] mq950:flex-wrap">
          ...
          <div className="w-[260px] flex flex-row items-start justify-start gap-[15px]">
            ...
            />
            <div className="flex-1 flex flex-col items-start justify-start pt-[22px] px-0 pb-0">
              <div className=" h-0 relative leading-[0%] font-medium inline-block z-[2]">
                Kevin Petersen
              </div>
            </div>
          </div>
